...
export interface POSBookingDetailOrderItem {
  id: string;
  name: string;
  category: string;
  quantity: number;
...
export interface POSBookingDetailFoodAllergy {
  id: number;
  allergen: string;
...
export interface POSBookingDetailDietaryRequirement {
  id: number;
  requirement: string;
  notes: string;
}

export interface POSBookingDetailGuestProfile {
  guestId: number;
  name: string;
  relation: 'Main Member' | 'Spouse' | 'Child' | 'Companion' | 'Guest';
  foodAllergies: POSBookingDetailFoodAllergy[];
  dietaryRequirements: POSBookingDetailDietaryRequirement[];
}

export interface POSBookingDetailBooking {
  bookingNo: string;
  suiteId: string;
  suiteName: string;
  memberName: string;
  ...
  foodAllergies: POSBookingDetailFoodAllergy[];
  dietaryRequirements: POSBookingDetailDietaryRequirement[];
  guestProfiles: POSBookingDetailGuestProfile[];
  checkInTime: string;
  flightNo: string;
  flightTime: string;
  flightDestination: string;
  numberOfGuests: number;
  orders: POSBookingDetailOrderItem[];
...
export interface POSBookingDetailMenuItem {
  id: string;
  name: string;
  price: number;
  category: string;
...
export interface POSBookingDetailCartItem extends POSBookingDetailMenuItem {
  quantity: number;
}

export interface POSBookingDetailProps {
  booking: POSBookingDetailBooking;
  menuItems: POSBookingDetailMenuItem[];
  initialCart?: POSBookingDetailCartItem[];
  onBack: () => void;
  onPlaceOrder?: (cart: POSBookingDetailCartItem[]) => void;
}

type OrderItem = POSBookingDetailOrderItem;
type MenuItem = POSBookingDetailMenuItem;
type CartItem = POSBookingDetailCartItem;

export function POSBookingDetail({ booking, menuItems, initialCart, onBack, onPlaceOrder }: POSBookingDetailProps) {
