...
const ALL_BOOKINGS: ScheduleBooking[] = [
  ...
  { id:6,  bookingNo:'A-202603-000006', guestName:'Robert Wang',       accountNo:'TA-WG-001',     venue:'Business Suite 2',  date:'2026-03-07', startTime:'11:30', endTime:'14:30', flightNo:'SQ801', flightTime:'15:45', numberOfGuests:3, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$4,420' },
  ...
  { id:10, bookingNo:'A-202603-000010', guestName:'EGL Tours — Grp A', accountNo:'TA-EG-001',     venue:'Lounge Table 1',    date:'2026-03-07', startTime:'06:30', endTime:'10:00', flightNo:'LH797', flightTime:'11:20', numberOfGuests:8, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$12,480'},
  ...
  { id:14, bookingNo:'A-202603-000014', guestName:'Wing On Travel Grp',accountNo:'TA-WO-001',     venue:'Lounge Table 2',    date:'2026-03-07', startTime:'11:00', endTime:'14:00', flightNo:'QF107', flightTime:'15:20', numberOfGuests:6, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$9,240' },
  { id:15, bookingNo:'A-202603-000015', guestName:'Hong Thai Travel',  accountNo:'TA-HT-001',     venue:'Business Suite 1',  date:'2026-03-07', startTime:'14:30', endTime:'17:30', flightNo:'SQ835', flightTime:'18:55', numberOfGuests:4, status:'Pending for Review',  accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$6,300' },
  ...
  { id:17, bookingNo:'A-202603-000017', guestName:'CTrip HK Group',    accountNo:'TA-CT-001',     venue:'Executive Suite 2', date:'2026-03-07', startTime:'14:00', endTime:'17:00', flightNo:'EK385', flightTime:'18:30', numberOfGuests:3, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$5,576' },
  ...
  { id:29, bookingNo:'A-202603-000029', guestName:'Klook Travel Grp',  accountNo:'TA-KL-001',     venue:'Lounge Table 4',    date:'2026-03-08', startTime:'09:00', endTime:'12:00', flightNo:'SQ801', flightTime:'13:15', numberOfGuests:7, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$10,584'},
  ...
  { id:35, bookingNo:'A-202603-000035', guestName:'Jetour Holidays',   accountNo:'TA-JT-001',     venue:'Lounge Table 5',    date:'2026-03-06', startTime:'10:00', endTime:'14:00', flightNo:'NH801', flightTime:'15:20', numberOfGuests:9, status:'Confirmed',           accountType:'Travel Agency', paymentMode:'On-Credit', amount:'HK$11,970'},
...
export function BookingSchedules({
  ...
  const travelAgencyCount= dayBookings.filter(b => b.accountType === 'Travel Agency').length;
